...
public class ConnectionsApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateConnectionCall(ConnectionEntity body, String id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateConnectionValidateBeforeCall(ConnectionEntity body, String id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateConnectionCall(body, id, progressListener, progressRequestListener);
        return call;
    ...
    public ConnectionEntity updateConnection(ConnectionEntity body, String id) throws ApiException {
        ApiResponse<ConnectionEntity> resp = updateConnectionWithHttpInfo(body, id);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ConnectionEntity> updateConnectionWithHttpInfo(ConnectionEntity body, String id) throws ApiException {
        com.squareup.okhttp.Call call = updateConnectionValidateBeforeCall(body, id, null, null);
        Type localVarReturnType = new TypeToken<ConnectionEntity>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateConnectionAsync(ConnectionEntity body, String id, final ApiCallback<ConnectionEntity> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateConnectionValidateBeforeCall(body, id, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ConnectionEntity>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
