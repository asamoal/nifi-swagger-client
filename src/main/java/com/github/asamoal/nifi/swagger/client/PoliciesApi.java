...
import com.github.asamoal.nifi.swagger.client.model.AccessPolicyEntity;
...
public class PoliciesApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateAccessPolicyCall(AccessPolicyEntity body, String id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateAccessPolicyValidateBeforeCall(AccessPolicyEntity body, String id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
    ...
    public AccessPolicyEntity updateAccessPolicy(AccessPolicyEntity body, String id) throws ApiException {
        ApiResponse<AccessPolicyEntity> resp = updateAccessPolicyWithHttpInfo(body, id);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<AccessPolicyEntity> updateAccessPolicyWithHttpInfo(AccessPolicyEntity body, String id) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateAccessPolicyAsync(AccessPolicyEntity body, String id, final ApiCallback<AccessPolicyEntity> callback) throws ApiException {
