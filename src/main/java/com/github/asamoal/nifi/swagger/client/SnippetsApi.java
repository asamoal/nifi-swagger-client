...
import com.github.asamoal.nifi.swagger.client.model.SnippetEntity;
...
public class SnippetsApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateSnippetCall(SnippetEntity body, String id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateSnippetValidateBeforeCall(SnippetEntity body, String id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
        ...
        com.squareup.okhttp.Call call = updateSnippetCall(body, id, progressListener, progressRequestListener);
        return call;
    ...
    public SnippetEntity updateSnippet(SnippetEntity body, String id) throws ApiException {
        ApiResponse<SnippetEntity> resp = updateSnippetWithHttpInfo(body, id);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<SnippetEntity> updateSnippetWithHttpInfo(SnippetEntity body, String id) throws ApiException {
        com.squareup.okhttp.Call call = updateSnippetValidateBeforeCall(body, id, null, null);
        Type localVarReturnType = new TypeToken<SnippetEntity>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateSnippetAsync(SnippetEntity body, String id, final ApiCallback<SnippetEntity> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateSnippetValidateBeforeCall(body, id, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<SnippetEntity>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
