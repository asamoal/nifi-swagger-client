...
import com.github.asamoal.nifi.swagger.client.model.TenantsEntity;
import com.github.asamoal.nifi.swagger.client.model.UserEntity;
import com.github.asamoal.nifi.swagger.client.model.UserGroupEntity;
import com.github.asamoal.nifi.swagger.client.model.UserGroupsEntity;
import com.github.asamoal.nifi.swagger.client.model.UsersEntity;
...
public class TenantsApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateUserCall(UserEntity body, String id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateUserValidateBeforeCall(UserEntity body, String id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
    ...
    public UserEntity updateUser(UserEntity body, String id) throws ApiException {
        ApiResponse<UserEntity> resp = updateUserWithHttpInfo(body, id);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<UserEntity> updateUserWithHttpInfo(UserEntity body, String id) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateUserAsync(UserEntity body, String id, final ApiCallback<UserEntity> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateUserGroupCall(UserGroupEntity body, String id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateUserGroupValidateBeforeCall(UserGroupEntity body, String id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
    ...
    public UserGroupEntity updateUserGroup(UserGroupEntity body, String id) throws ApiException {
        ApiResponse<UserGroupEntity> resp = updateUserGroupWithHttpInfo(body, id);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<UserGroupEntity> updateUserGroupWithHttpInfo(UserGroupEntity body, String id) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateUserGroupAsync(UserGroupEntity body, String id, final ApiCallback<UserGroupEntity> callback) throws ApiException {
