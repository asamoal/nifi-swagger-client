...
public class ProcessGroupDTO {
  ...
  public enum FlowfileConcurrencyEnum {
    ...
    public static class Adapter extends TypeAdapter<FlowfileConcurrencyEnum> {
      ...
      public FlowfileConcurrencyEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return FlowfileConcurrencyEnum.fromValue((String)(value));
      }
    }
  ...
  public enum FlowfileOutboundPolicyEnum {
    ...
    public static class Adapter extends TypeAdapter<FlowfileOutboundPolicyEnum> {
      ...
      public FlowfileOutboundPolicyEnum read(final JsonReader jsonReader) throws IOException {
        Object value = jsonReader.nextString();
        return FlowfileOutboundPolicyEnum.fromValue((String)(value));
      }
    }
  ...
  **/
   ...
   * @return variables
  **/
  @Schema(description = "The variables that are configured for the Process Group. Note that this map contains only those variables that are defined on this Process Group and not any variables that are defined in the parent Process Group, etc. I.e., this Map will not contain all variables that are accessible by components in this Process Group by rather only the variables that are defined for this Process Group itself.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, versionedComponentId, parentGroupId, position, name, comments, variables, versionControlInformation, parameterContext, flowfileConcurrency, flowfileOutboundPolicy, defaultFlowFileExpiration, defaultBackPressureObjectThreshold, defaultBackPressureDataSizeThreshold, runningCount, stoppedCount, invalidCount, disabledCount, activeRemotePortCount, inactiveRemotePortCount, upToDateCount, locallyModifiedCount, staleCount, locallyModifiedAndStaleCount, syncFailureCount, localInputPortCount, localOutputPortCount, publicInputPortCount, publicOutputPortCount, contents, inputPortCount, outputPortCount);
  }
