...
import com.github.asamoal.nifi.swagger.client.model.VariableEntity;
...
public class VariableRegistryDTO {
   ...
   * @return variables
  **/
  @Schema(description = "The variables that are available in this Variable Registry")
  ...
  **/
  @Schema(description = "The UUID of the Process Group that this Variable Registry belongs to")
