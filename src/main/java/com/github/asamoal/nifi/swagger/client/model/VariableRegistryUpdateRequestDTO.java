...
import com.github.asamoal.nifi.swagger.client.model.VariableRegistryUpdateStepDTO;
...
public class VariableRegistryUpdateRequestDTO {
  ...
  **/
  @Schema(description = "The unique ID of the Process Group that the variable registry belongs to")
  ...
  **/
  @Schema(description = "A set of all components that will be affected if the value of this variable is changed")
