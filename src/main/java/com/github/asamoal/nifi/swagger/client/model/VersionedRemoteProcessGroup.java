...
import com.github.asamoal.nifi.swagger.client.model.VersionedRemoteGroupPort;
...
public class VersionedRemoteProcessGroup {
  ...
  public enum TransportProtocolEnum {
    ...
    public static class Adapter extends TypeAdapter<TransportProtocolEnum> {
      ...
      public TransportProtocolEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return TransportProtocolEnum.fromValue((String)(value));
      }
    }
  ...
  **/
   ...
   * @return targetUri
  **/
  @Schema(description = "[DEPRECATED] The target URI of the remote process group. If target uri is not set, but uris are set, then returns the first uri in the uris. If neither target uri nor uris are set, then returns null.")
