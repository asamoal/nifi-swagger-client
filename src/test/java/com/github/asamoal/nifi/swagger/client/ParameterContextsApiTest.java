...
public class ParameterContextsApiTest {
    ...
    public void submitParameterContextUpdateTest() throws Exception {
        ParameterContextEntity body = null;
        String contextId = null;
        ParameterContextUpdateRequestEntity response = api.submitParameterContextUpdate(body, contextId);
    ...
    public void submitValidationRequestTest() throws Exception {
        ...
        String contextId = null;
        ParameterContextValidationRequestEntity response = api.submitValidationRequest(body, contextId);
    ...
    public void updateParameterContextTest() throws Exception {
        ParameterContextEntity body = null;
        String id = null;
        ParameterContextEntity response = api.updateParameterContext(body, id);
